// ====== СЛОВА (ваш список) ======
const VOCAB = [
  { en: "Reset", ru: "сброс; перезагрузка", pron: "ри-СЭТ" },
{ en: "Wave", ru: "волна; сигнал", pron: "ВЭЙВ" },
{ en: "Recognize", ru: "распознавать", pron: "РЕ-кэг-найз" },
{ en: "Single", ru: "одиночный; единственный", pron: "СИН-гл" },
{ en: "Acquisition", ru: "сбор (данных); получение", pron: "э-кви-ЗИ-шн" },
{ en: "Scalar", ru: "скаляр; скалярная величина", pron: "СКЭЙ-лэр" },
{ en: "Represent", ru: "представлять; отображать", pron: "ре-пре-ЗЕНТ" },
{ en: "Extract", ru: "извлекать; вытяжка", pron: "ИКС-трэкт" },
{ en: "Extracting", ru: "извлечение", pron: "икс-ТРЭК-тин" },
{ en: "Slope", ru: "наклон; крутизна", pron: "СЛОУП" },
{ en: "Ramp", ru: "пилообразный сигнал; наклон", pron: "РЭМП" },
{ en: "Pattern", ru: "шаблон; образец", pron: "ПЭ-тэрн" },
{ en: "Empty", ru: "пустой", pron: "ЭМП-ти" },
{ en: "Streaming", ru: "потоковая передача", pron: "СТРИ-мин" },
{ en: "Folder", ru: "папка", pron: "ФОУЛ-дэр" },
{ en: "Relative", ru: "относительный", pron: "РЕ-лэ-тив" },
{ en: "Common", ru: "общий; обычный", pron: "КО-мэн" },
{ en: "Log", ru: "журнал; лог; регистрация", pron: "ЛОГ" },
{ en: "Requires", ru: "требует", pron: "ри-КВАЙ-ерз" },
{ en: "Improve", ru: "улучшать", pron: "им-ПРУВ" },
{ en: "Both on", ru: "оба включены", pron: "БОУС он" },
];
